...
var Downloader, Path, Url, colors, crypto, defaultFileName, file, fs, isLocalUrl, isRemoteUrl, protocols;
...
module.exports = Downloader = (function() {
  ...
  Downloader.prototype.download = function(img, callback) {
    ...
    if (isLocal) {
      ...
      img.localPath = url;
      img.skipped = true;
      return typeof callback === "function" ? callback(null, url) : void 0;
    }
  };
